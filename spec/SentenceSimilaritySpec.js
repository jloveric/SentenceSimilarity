...
let sentence6 = ["a", "bunch", "of", "stuff", "What", "is", "John", "Loverich", "email"]
let sentence7 = ["email", "Loverich", "John", "is", "What"]
let sentence8 = ["Loverich", "will", "have", "a", "pretty", "low", "score",
    "because", "of", "the", "size", "of", "this", "John"]
...
describe("Test SentenceSimilarity", function () {
    ...
    it("Low score", function (done) {
        ...
        let sim = similarity(sentence4, sentence8, { f: similarityScore.metaphoneDl, options : {threshold: 0.3} })
    ...
    it("Failing score", function (done) {
        //Somewhat similar
        //let sim = similarity(sentence4, sentence8, similarityScore.commonScore )
        let sim = similarity(["any","salmon"], ["summon", "(name)"], similarityScore.commonScore)
